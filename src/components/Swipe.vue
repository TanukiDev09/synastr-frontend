<template>
  <div class="swipe">
    <div class="swipe__header">
      <router-link to="/likers" class="likers-button">Ver mis Likes</router-link>
    </div>
...
import { likeUser } from '../graphql/mutations'; // Asumo que tienes este import
...
/* ✅ 2. ESTILOS PARA EL NUEVO ENCABEZADO Y BOTÓN */
.swipe__header {
  margin-bottom: 1rem;
  text-align: right;
}
